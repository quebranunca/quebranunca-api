...
public interface IDashboardDuplaServico
{
    Task<DashboardDuplaDto> ObterDashboardAsync(
        Guid atleta1Id,
        Guid atleta2Id,
        CancellationToken cancellationToken = default);
}
...
public interface IPartidaServico
{
    ...
    Task<CriarPartidaResultadoDto> CriarComResultadoAsync(CriarPartidaDto dto, CancellationToken cancellationToken = default);
...
public interface IPendenciaServico
{
    ...
    Task<PendenciasResumoDto> ObterResumoAsync(CancellationToken cancellationToken = default);
